...
var Wizard = (function (_React$Component) {
  ...
  _createClass(Wizard, [{
    ...
    value: function render() {
      ...
      var currentComponent = _react2['default'].createElement(this.props.components[this.state.currentComponentIndex].component, { onNextEnded: this.onNextEnded.bind(this),
